...
1. **event nominals:**  
1.1 verbal nouns ending with _-ní/tí_  --> inherit the value from the verb  (like _Milovala **nakupování.activity**_; _Na naše **dotázání (se).performance** neodpověděli._)  
