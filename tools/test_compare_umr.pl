...
system("perl $script_path/compare_umr.pl DZ $czech_path/mf920922-133_estonsko-DZ.umr ML $czech_path/mf920922-133_estonsko-ML.umr > $czech_path/comparison-DZ-ML.txt");
...
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/ln94210_111-ML-all.umr CONV $pdttest_path/ln94210_111-conv.umr > $pdttest_path/evaluation-ln94210_111.txt");
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/ln95046_093-HH-all.umr CONV $pdttest_path/ln95046_093-conv.umr > $pdttest_path/evaluation-ln95046_093.txt");
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/pdtsc_093_3.02-ML-all.umr CONV $pdttest_path/pdtsc_093_3.02-conv.umr > $pdttest_path/evaluation-pdtsc_093_3.02.txt");
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/pdtsc_146_2.05-HH-all.umr CONV $pdttest_path/pdtsc_146_2.05-conv.umr > $pdttest_path/evaluation-pdtsc_146_2.05.txt");
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/wsj0013.cz-ML.umr CONV $pdttest_path/wsj0013.cz-conv.umr > $pdttest_path/evaluation-wsj0013.cz.txt");
system("perl $script_path/compare_umr.pl GOLD $pdttest_path/wsj0072.cz-HH.umr CONV $pdttest_path/wsj0072.cz-conv.umr > $pdttest_path/evaluation-wsj0072.cz.txt");
