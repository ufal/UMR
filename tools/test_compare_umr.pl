...
system("perl $script_path/compare_umr.pl ML $pdttest_path/ln94210_111-ML.umr HH $pdttest_path/ln94210_111-HH-s1-s5.umr > $pdttest_path/comparison-ln94210_111.txt");
